  ...
  return (
    <div className='app'>
      ...
      <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-6">
        <h1 className="text-3xl font-bold mb-4">Terms and Conditions for Gold's Gym Ganeshguri Box Gym</h1>
        <p className="text-gray-700">Effective Date: 25/02/2025</p>
        
        <section className="mt-4">
          <h2 className="text-xl font-semibold">1. Introduction</h2>
          <p className="text-gray-700">Welcome to Gold's Gym Ganeshguri Box Gym. By accessing or using our services, you agree to comply with and be bound by these Terms and Conditions.</p>
        </section>
        ...
        <section className="mt-4">
          ...
          <p className="text-gray-700">Gold's Gym Ganeshguri Box Gym is not responsible for injuries, lost items, or accidents that occur within the premises.</p>
        </section>
